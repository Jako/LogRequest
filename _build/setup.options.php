...
switch ($options[xPDOTransport::PACKAGE_ACTION]) {
    case xPDOTransport::ACTION_INSTALL:
        $output .= '<h2>Install LogRequest</h2>

        <p>Thanks for installing LogRequest. This open source extra was
    ...
    case xPDOTransport::ACTION_UPGRADE:
        $output .= '<h2>Upgrade LogRequest</h2>

        <p>LogRequest will be upgraded. This open source extra was developped by
