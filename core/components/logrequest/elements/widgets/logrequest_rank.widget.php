...
class modDashboardWidgetLogrequestRank extends modDashboardWidgetInterface
{
    /**
     * @return string
     */
    ...
    MODx.load({
        ...
        renderTo: "modx-grid-logrequest-rank",
        connector_url: "' . $logrequest->getOption('connectorUrl') . '"
    });
});</script>');

        return $this->getFileChunk($logrequest->getOption('templatesPath') . 'logrequest_rank.tpl');
    }
}
